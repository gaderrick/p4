...
class OrganizationsTableSeeder extends Seeder
{
    public function run()
    {
        $organizations = [
            ...
            [1,1,'Elmwood Gymnastics Academy','700 C ElmwoodPark Blvd.','Harahan',18,70123,3,'http://www.ochsnerfitness.com/club/scripts/section/section.asp?NS=GYMNASTIC','Toni Mortillaro','Hillaryhebert@hotmail.com','504-733-4496','A0003','']
